...
def export_apel_daily_command(
    ...
    summary.add_row("Jobs exported", str(result.jobs_exported))
    summary.add_row("Jobs skipped", str(result.jobs_skipped))
    summary.add_row("Allowed schedds", ", ".join(result.allowed_schedds))
